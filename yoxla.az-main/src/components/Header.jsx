        ...
        <div className="flex items-center space-x-3">
          ...
          {customActions.map((action, index) => (
            <button
              ...
              className={action.className || "p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"}
            >
              {action.icon}
            </button>
          ))}
            ...
            {userMenuOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-xl border dark:border-gray-700 py-2">
                <div className="px-4 py-3 border-b dark:border-gray-700">
                  ...
                  {user?.company && (
                    <div className="flex items-center mt-2">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">{user.company}</span>
                    </div>
                  )}
                </div>
                ...
                >
                  ...
                  <span className="text-sm text-gray-700 dark:text-gray-300">Abunəlik</span>
                </button>
                ...
                >
                  ...
                  <span className="text-sm text-gray-700 dark:text-gray-300">Təhlükəsizlik</span>
                </button>
